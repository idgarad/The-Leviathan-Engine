Perfect—let’s add that as a formal **Addendum** to the **Crafting & Manufacturing Codex**, since it ties directly into persistence, campaign resets, and factional gating. Here’s the updated, finalized version with the addendum included:
...
- **Automated Industry**  
  ...
  - However, factories **log the submitting Operator’s identity** for taxation, auditing, and Imperial oversight.  
...
- **Political Consequences**  
  - Operators may manufacture rival corporate products in a House’s territory.  
...
- **Bootstrap Narratives**: Early campaigns are remembered for their “lean years,” when Operators scrambled to establish the first industrial chains.  
...
Would you like me to **draft the Jurisdiction & Taxation Codex next** (Arrays, Stewards, Governors, and how their tax layers interact with Imperial law and faction standings), since that’s the natural extension of this economic framework?
